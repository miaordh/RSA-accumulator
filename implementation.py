...
import time
import merkletools
from helpfunctions import hash_to_prime, write_list_to_file, extract_merkle_proof, create_random_list, hash_integers, to_padded_num_str, make_even_size

RANDOM_LIST_SIZE = 1000
SINGLE_PROVE_INDEX = 8 # Don't forget to change it in interact.js as well
BATCH_PROVE_SIZE = 900
sys.set_int_max_str_digits(1000000)

# Create random list
random_list = create_random_list(RANDOM_LIST_SIZE)
